(function (root, factory) {
  ...
  function defaultGenerationSystemPrompt() {
    return [
      ...
      "",
      "Convert Premiere timeline markers, director comments, and optional editor answers into concise English fields for Suno. The cue is usually for picture, so prioritize emotional arc, pacing, instrumentation, texture, energy, and hit points over generic song description.",
      "",
      ...
      "- Prefer specific musical behavior over abstract adjectives: what enters, what recedes, what builds, what should stay restrained.",
  ...
  function buildExternalLlmPrompt(cue, interviewAnswers, options) {
    ...
    return [
      ...
      "",
      "Task:",
      "Use the included Premiere marker data and director notes to generate Suno Advanced/Custom Mode fields. The source comments may be in Chinese or English, but your final Suno fields should be concise, production-oriented English.",
      "",
      "Constraints:",
